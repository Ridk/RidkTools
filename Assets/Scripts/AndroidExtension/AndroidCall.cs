...
/// <param name="NegativeEvent">Negative event.</param>
    public static void ShowAlertDialog(string title = "提示!", string Message = "是否退出?", string positiveButtonText =
 "是", string negativeButtonText = "否", Action PositiveEvent = null, Action NegativeEvent = null)
    {
