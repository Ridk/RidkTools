...
namespace Ridk
{
    public class BLEDveice
    {
        ...
        void ScanDveice()
        {
            ...
            AndroidJavaObject wfzScanCallback = new AndroidJavaObject("com.rikd.unityextension.RidkScanCallback");
        ...
        {
            AndroidJavaObject wfzBluetoothGattCallback =
                new AndroidJavaObject("com.ridk.unityextension.RidkBluetoothGattCallback");
            ...
            buetoothGatt = device.Call<AndroidJavaObject>("connectGatt", AndroidCall.unityActivity, true,
                wfzBluetoothGattCallback);
        }
        ...
        public void NotificationData(AndroidJavaObject gatt, AndroidJavaObject characteristic, string uuid)
        {
            ...
            if (b)
            {
                ...
                var isSet = descriptor.Call<bool>("setValue",
                    bluetoothGattDescriptor.GetStatic<byte[]>("ENABLE_NOTIFICATION_VALUE"));
                if (isSet)
                {
